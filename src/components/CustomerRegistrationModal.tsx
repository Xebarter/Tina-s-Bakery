...
import { X, User, Phone, Mail, MapPin, Building, Loader } from 'lucide-react';
import { customerService, CustomerRegistrationData } from '../services/customerService';
...
export function CustomerRegistrationModal({ 
  ...
  const [formData, setFormData] = useState<CustomerRegistrationData>({
    ...
    registrationSource: initialData?.registrationSource || 'direct',
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const customer = await customerService.registerCustomer(formData);
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={isLoading || !formData.fullName.trim() || !formData.phone.trim() || !formData.address.trim() || !formData.city.trim()}
          ...
          <div className="mt-6 text-center">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
              <p className="text-blue-800 text-sm">
                <strong>Customer Registration:</strong> All fields marked with * are required. 
                Phone number will be used as the unique identifier for this customer.
              </p>
            </div>
          </div>
        </div>
